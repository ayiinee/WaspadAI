...
data class VerificationUiState(
    ...
    val editingConversationId: String? = null,
    val renameDraft: String = "",
    val pendingDeleteConversationId: String? = null,
    val isConversationMutationRunning: Boolean = false,
    val uiMessage: String? = null,
    val uiMessageRetryAction: VerificationAction? = null,
    val composerFocusRequest: Int = 0,
