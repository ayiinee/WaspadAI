...
Versi 3.0.1-draft. Runbook TARGET. Paket berisi dokumentasi dan draft kontrak, **bukan scaffold aplikasi yang langsung runnable**. Perintah backend/Android/test/Compose di bawah hanya berlaku setelah file target diimplementasikan. Tidak ada database/deployment yang dibuat atau diubah saat menyusun paket ini.
